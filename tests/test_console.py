...
class TestConsoleDocs(unittest.TestCase):
    """Class test for document the console"""
...
class TestConsoleCommands(unittest.TestCase):
    """Class test to function for console CMD"""
    @classmethod
    def setUpClass(cls):
        """Create CMD console to test with"""
        cls.cmdcon = HBNBCommand()

    def setUp(self):
        """Create the memory buffer to capture stdout"""
        self.output = io.StringIO()

    def tearDown(self):
        """shut the memory buffer after test completes"""
        self.output.close()

    @unittest.skipIf(os.getenv('HBNB_TYPE_STORAGE') == 'db',
                     "Testing DBStorage")
    def test_do_create(self):
        """test of do_create method of console"""
